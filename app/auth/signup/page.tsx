...
import { SignupAuthForm } from '@/components/auth/signup-auth-form';
...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex bg-[oklch(0.118_0.008_264)] relative overflow-hidden text-white">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-indigo-500/20 rounded-full blur-[120px] pointer-events-none" />
      ...
      <motion.div 
        ...
        className="hidden lg:flex w-1/2 relative p-12 items-center justify-center border-r border-white/[0.05] bg-white/[0.01]"
      >
        ...
        <div className="relative z-10 w-full max-w-lg bg-white/[0.03] backdrop-blur-xl border border-white/[0.08] rounded-3xl p-12 flex flex-col gap-8 transition-transform hover:scale-[1.01] duration-500 shadow-2xl">
          <div className="space-y-4">
            <h2 className="text-3xl xl:text-4xl font-bold text-white leading-tight">
              Join the data <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">Intelligence Era</span>
            </h2>
            <p className="text-lg text-white/40">
              Create an account and start predicting CLV with enterprise-grade machine learning models.
            </p>
          </div>
          ...
          <div className="space-y-6 pt-6 border-t border-white/[0.08]">
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="font-semibold text-white text-lg">Dynamic Datasets</h3>
                <p className="text-white/40 text-sm mt-1">Upload CSVs directly. Our platform autonomously processes and extracts features.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="font-semibold text-white text-lg">Deep BI Analytics</h3>
                <p className="text-white/40 text-sm mt-1">Interactive dashboards pre-built to slice your ML pipeline outputs.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          >
            ...
            <p className="text-white/40 text-lg">
              Get started with your ML intelligence journey.
            </p>
          </motion.div>
